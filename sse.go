...
type SideEventer interface {
	SendEvent(eventer)
	HandlerConnectNotify(func(cid interface{}))
	HandlerDisconnectNotify(func(cid interface{}))
	HandlerReconnectNotify(func(cons *Reconnect))
	RemoveConsumer(cid interface{})
	CountConsumer() int
	HandlerHTTP(cid interface{}, w http.ResponseWriter, r *http.Request)
	Close()
}
